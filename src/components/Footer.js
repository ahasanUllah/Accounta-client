...
import { FaAccessibleIcon, FaFileInvoiceDollar } from 'react-icons/fa';
               ...
               <div className="lg:w-1/3">
                  <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                     <div className="flex items-center justify-center w-12 h-12 rounded-full bg-teal-600">
                        <FaFileInvoiceDollar className="text-white text-2xl"></FaFileInvoiceDollar>
                     </div>
                     <span className="self-center text-2xl font-semibold">Accounta</span>
                  </a>
               </div>
